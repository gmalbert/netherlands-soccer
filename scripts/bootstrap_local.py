...
def main() -> None:
    ...
    # Historical Open-Meteo backfills are too slow and incomplete for the
    # reproducible production-model contract. Live weather remains available
    # to the app as contextual information outside the classifier.
    environment["PITCH_ORACLE_DISABLE_WEATHER"] = "1"
    commands = (
